...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s2 = new Seller(2, "Maria Green", "green@gmail.com", new DateTime(1990, 8, 15), 1500.00, d2);
            Seller s3 = new Seller(3, "Jack Black", "jackb@gmail.com", new DateTime(1985, 10, 04), 2000.00, d3);
            Seller s4 = new Seller(4, "Ruth Red", "reddie@gmail.com", new DateTime(2000, 9, 07), 1700.00, d4);
            Seller s5 = new Seller(5, "Marcus Blue", "bluem@gmail.com", new DateTime(1994, 4, 12), 1390.00, d1);
            Seller s6 = new Seller(6, "Millie Brown", "milbrown@gmail.com", new DateTime(1996, 4, 25), 1200.00, d2);
